          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
              <span className="font-bold text-neutral-700 dark:text-neutral-200">
                Plan Your Next City Adventure.
              </span>{" "}
              Discover iconic landmarks, local culture, and unforgettable
              experiences in each destination. Compare highlights across popular
              cities to choose the trip that matches your interests and travel
              style.
            </p>
            <Image
...
const data = [
  ...
  },
  {
    ...
    title: "Harbour City – Opera House, Bondi Beach & Wildlife",
