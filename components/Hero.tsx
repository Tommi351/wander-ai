  ...
  return (
    <div className="mt-24 flex justify-center">
      ...
      <div className="max-w-3xl w-full text-center space-y-6">
        <h1 className="text-xl md:text-5xl text-black font-bold">
        ...
        <div className="flex gap-5">
          {suggestions.map((suggestions, index) => (
            <div
              key={index}
              className="flex items-center gap-2 border rounded-full p-2 cursor-pointer hover:bg-orange-500 hover:text-white"
            >
              {suggestions.icon}
        ...
        <div className="flex items-center justify-center flex-col">
          <h2 className="my-7 mt-14 flex gap-2 text-center text-black">
